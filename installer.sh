...
# Update Logic
if [ "\$1" == "update" ]; then
    echo -e "\033[1;32m[+] Fetching latest updates from SHI's GitHub...\033[0m"
...
echo -e "\033[1;32m  │\033[0m  \033[1;37mwifux contact\033[0m → Contact the developer (SHI)"
...
echo -e "\033[1;36m     https://github.com/Shirotaa-z/Wif\033[0m"
