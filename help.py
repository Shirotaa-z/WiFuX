...
{LINE2}
  ...
  {W}SHIROTAA (SHI){RS}
  GitHub  : {C}shirotaa-z{RS}
  Website : {C}nothing{RS}

{TIP} {M}Stay With SHI — Stay safe, stay ethical.{RS}
''')
    pause()
...
def main():
    ...
    while True:
        ...
        if choice == '0':
            clear()
            print(f'\n{M}  ★ Stay With SHI — Thanks for using WiFuX!{RS}\n')
            sys.exit(0)
