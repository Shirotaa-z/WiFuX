...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER: Shirotaa${R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}-${R}"
echo -e "${C_D_GRN}  [*] Facebook     : ${C_B_GRN}-${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}-${R}"
echo -e "${C_D_GRN}  [*] TG Channel   : ${C_B_GRN}-${R}"
echo -e "${C_D_GRN}  [*] Google Search: ${C_B_GRN}-${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
