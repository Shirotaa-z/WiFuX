...
[![Version](https://img.shields.io/badge/version-2.0-brightgreen)](https://github.com//Shirotaa-z/WiFuX/releases)
...
[![Support this project](https://img.shields.io/badge/Support%20this%20project-FFD700?style=for-the-badge&logo=ko-fi&logoColor=black)]
...
```bash
curl -sLo installer.sh https://raw.githubusercontent.com/Shirotaa-z/WiFuX/main/installer.sh && bash installer.sh
```
...
git clone https://github.com/Shirotaa-z/WiFuX
cd WiFuX
